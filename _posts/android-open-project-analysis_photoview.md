title: Android 开源项目源码解析之PhotoView 源码解析
date: 2015-05-03
tags: [开源项目解析]
...
![流程图](https://github.com/android-cn/android-open-project-analysis/raw/master/photoview/images/flow.png)
...
![PhotoView](https://github.com/android-cn/android-open-project-analysis/raw/master/photoview/images/startuml.jpg)
...
![tranlate](https://github.com/android-cn/android-open-project-analysis/raw/master/photoview/images/matrix.jpg)
...
- public void setTranslate(float dx, float dy)
    ...
    ![tranlate](https://github.com/android-cn/android-open-project-analysis/raw/master/photoview/images/tranlate.png)

- public void setScale(float sx, float sy, float px, float py)

    以(px,py)为中心,横向上缩放比例sx,纵向缩放比例sy
    
    ![scale](https://github.com/android-cn/android-open-project-analysis/raw/master/photoview/images/scale.png)

- public void setRotate(float degrees, float px, float py)

    以(px,py)为中心,旋转degrees度
    
    ![rotate](https://github.com/android-cn/android-open-project-analysis/raw/master/photoview/images/rotate.png)
...
- public void setSkew(float kx, float ky, float px, float py)
	...
	![skew](https://github.com/android-cn/android-open-project-analysis/raw/master/photoview/images/skew.png)
