title: Android 开源项目源码解析之EventBus 源码解析
date: 2015-05-03
tags: [开源项目解析]
...
![eventbus img](https://github.com/android-cn/android-open-project-analysis/raw/master/event-bus/image/relation-flow-chart.png)  
EventBus 负责存储订阅者、事件相关信息，订阅者和发布者都只和 EventBus 关联。  

####3.2 事件响应流程
![eventbus img](https://github.com/android-cn/android-open-project-analysis/raw/master/event-bus/image/event-response-flow-chart.png)  
订阅者首先调用 EventBus 的 register 接口订阅某种类型的事件，当发布者通过 post 接口发布该类型的事件时，EventBus 执行调用者的事件响应函数。 

###4. 详细设计
####4.1 类关系图
![eventbus img](https://github.com/android-cn/android-open-project-analysis/raw/master/event-bus/image/class-relation.png)  
...
register 函数流程图如下：
![eventbus img](https://github.com/android-cn/android-open-project-analysis/raw/master/event-bus/image/register-flow-chart.png)  
...
post 函数流程图如下：
![eventbus img](https://github.com/android-cn/android-open-project-analysis/raw/master/event-bus/image/post-flow-chart.png)  
