title: Android 开源项目源码解析之Volley 源码解析
date: 2015-05-03
tags: [开源项目解析]
...
> 发布演讲时候的配图  
> ![Volley](https://github.com/android-cn/android-open-project-analysis/raw/master/volley/image/volley.png)
...
###2. 总体设计
####2.1. 总体设计图  
![总体设计图](https://github.com/android-cn/android-open-project-analysis/raw/master/volley/image/design.png)  
...
###3. 流程图
Volley 请求流程图  
![Volley请求流程图](https://github.com/android-cn/android-open-project-analysis/raw/master/volley/image/Volley-run-flow-chart.png)  
> **上图是 Volley 请求时的流程图，在  Volley 的发布演讲中给出，我在这里将其用中文重新画出。**   

###4. 详细设计
####4.1 类关系图
![类关系图](https://github.com/android-cn/android-open-project-analysis/raw/master/volley/image/volley-class.png)  
这是 Volley 框架的主要类关系图    
...
流程图如下：  
![加入请求流程图](https://github.com/android-cn/android-open-project-analysis/raw/master/volley/image/RequestQueue-add-flow-chart.png)  
...
####(2). 处理流程图
![缓存调度线程处理流程图](https://github.com/android-cn/android-open-project-analysis/raw/master/volley/image/CacheDispatcher-run-flow-chart.png)  
...
####(2). 处理流程图  
![网络调度线程处理流程图](https://github.com/android-cn/android-open-project-analysis/raw/master/volley/image/NetworkDispatcher-run-flow-chart.png)  
...
![Volley](https://github.com/android-cn/android-open-project-analysis/raw/master/volley/image/response-process-flow-chart.png)  
